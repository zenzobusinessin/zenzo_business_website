    ...
    <footer className="bg-inverse-surface text-on-tertiary-fixed pt-xl pb-lg">
      <div className="max-w-7xl mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-2 md:grid-cols-4 gap-lg mb-xl">
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="text-on-surface-variant text-body-md mb-md">Empowering Hyderabad's businesses with intelligent WhatsApp automation that works as hard as you do.</p>
        ...
        <div>
          ...
          <ul className="space-y-sm text-surface-variant">
            <li><a className="hover:text-primary-fixed transition-colors" href="#">Coaching Bots</a></li>
            <li><a className="hover:text-primary-fixed transition-colors" href="#">Retail Automation</a></li>
            <li><a className="hover:text-primary-fixed transition-colors" href="#">AI Chat Support</a></li>
            <li><a className="hover:text-primary-fixed transition-colors" href="#">API Integration</a></li>
          </ul>
        </div>
        <div>
